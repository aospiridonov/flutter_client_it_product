...
import '../../feature/posts/data/network_post_repository.dart' as _i10;
import '../../feature/posts/domain/post_repository.dart' as _i9;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i9.PostRepository>(
      () => _i10.NetworPostRepository(get<_i5.AppApi>()));
